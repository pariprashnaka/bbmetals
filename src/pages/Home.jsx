    ...
    <div className="home">
      ...
      <div className="hero">
        ...
        <div className="hero-img-bg">
          <img src="/images/IMAGE_1___Hero_background.webp" alt="Manufacturing facility" style={{ width:'100%', height:'100%', objectFit:'cover' }} />
        </div>
        <div className="hero-overlay" />
        <div className="hero-fire-top" />
        <div className="hero-content container">
          <div className="hero-eyebrow">Bishwambhar Bharat Metals · Made in Bihar, India</div>
          <h1>Strength forged<br />in every piece.<br /><span>Built for every home.</span></h1>
          <p className="hero-sub">Premium stainless steel kitchenware — built to last, crafted with consistency, and available for homes, restaurants, and businesses across India.</p>
      ...
      <section className="section" style={{ background: 'var(--navy)' }}>
        <div className="container">
          <div className="flex-between mb-40">
            <div><div className="lbl">What we make</div><div className="accent-rule" /><h2 style={{ color: '#fff' }}>Our product range</h2></div>
            <Link to="/products" className="btn-outline-light">View all products</Link>
          </div>
          <div className="prod-grid">
            {[
              { name: 'Stainless steel plates', desc: 'Classic thali in food-grade SS. Built for everyday home use and beyond.', img: '/images/IMAGE_5___Products_page___Product_1.webp', alt: 'Stainless steel plates' },
              { name: 'Stainless steel bowls', desc: 'Seamless katori and serving bowls. Smooth finish, sturdy for every meal.', img: '/images/IMAGE_6___Products_page___Product_2_.webp', alt: 'Stainless steel bowls' },
              { name: 'Stainless steel glasses', desc: 'Rust-free tumblers built to last. A staple in every Indian household.', img: '/images/IMAGE_7___Products_page___Product_3_.webp', alt: 'Stainless steel glasses' },
              { name: 'Other kitchenware', desc: 'More SS kitchen items available. Tell us what you need.', img: '/images/IMAGE_8___Products_page___Product_4.webp', alt: 'Other metal products' },
            ].map((p) => (
      ...
      <div className="q-split">
        <div className="q-img-side"><img loading="lazy" src="/images/IMAGE_3___Homepage_quality_section.webp" alt="Quality inspection" style={{ width:'100%', height:'100%', objectFit:'cover' }} /></div>
        <div className="q-content-side">
          ...
          <Link to="/quality" className="btn-outline-light" style={{ marginTop: 28 }}>View quality details</Link>
        </div>
      </div>
        ...
        <div className="container">
          <div className="flex-between">
            ...
            <div className="flex-gap">
              ...
              <Link to="/contact" className="btn-primary">✉️ Enquiry form</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="section" style={{ background: 'var(--light)' }}>
        <div className="container">
          <div className="flex-between mb-40">
            <div><div className="lbl">Knowledge &amp; insights</div><div className="accent-rule" /><h2 style={{ color: 'var(--navy)' }}>From our blog</h2></div>
            <Link to="/blog" className="btn-outline-dark">View all articles</Link>
          </div>
          <div className="blog-grid">
            {[
              { cat: 'Product knowledge', date: '12 Jan 2025', title: 'Understanding SS grades: 202, 304 and what they mean', desc: 'A plain-language guide to grades used in kitchenware — what the numbers mean and what to look for.', img: '/images/Blog_Image_1___Steel_grades_article.webp', slug: 'ss-grades-202-304-guide' },
              { cat: 'Manufacturing', date: '5 Jan 2025', title: 'How stainless steel utensils are made: from coil to kitchen', desc: 'A step-by-step look at the production process — explained simply for every buyer.', img: '/images/Blog_Image_2___Manufacturing_process_article_.webp', slug: 'how-ss-utensils-are-made' },
              { cat: 'Industry insights', date: '28 Dec 2024', title: "Why stainless steel remains India's favourite kitchenware material", desc: 'Durability, hygiene, and value — the reasons SS stays dominant in Indian homes.', img: '/images/Blog_Image_3___Industry_insights_article.webp', slug: 'why-stainless-steel-dominates-india' },
            ].map((b) => (
