...
export default function About() {
  return (
    <div>
      <SEO title="About Us" description="Learn about Bishwambhar Bharat Metals — stainless steel manufacturer in Bihar, India. Our values, vision, and roadmap." path="/about" image="/images/IMAGE_4___About_us_page.webp" />
        ...
        <div className="container">
          <div className="page-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72 }}>
            ...
            <div>
              ...
              <img src="/images/IMAGE_4___About_us_page.webp" alt="Our facility" style={{ width:'100%', height:'240px', objectFit:'cover', borderRadius:2 }} />
            </div>
          </div>
          <hr className="div-lt" />
          <div className="page-grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72 }}>
