...
const items = [
  { cat: 'manufacturing', label: 'Press operation', img: '/images/Gallery_Image_1___Press_operation.webp' },
  { cat: 'products', label: 'Metal products', img: '/images/Gallery_Image_2___Metal_products.webp' },
  { cat: 'manufacturing', label: 'Polishing line', img: '/images/Gallery_Image_3___Polishing_line.webp' },
  { cat: 'manufacturing', label: 'Quality inspection', img: '/images/Gallery_Image_4___Quality_inspection.webp' },
  { cat: 'facility', label: 'Production floor', img: '/images/Gallery_Image_5___Production_floor.webp' },
  { cat: 'products', label: 'Metal components', img: '/images/Gallery_Image_6___Metal_components.webp' },
  { cat: 'manufacturing', label: 'Metal forming', img: '/images/Gallery_Image_7___Metal_forming.webp' },
  { cat: 'packaging', label: 'Packaging', img: '/images/Gallery_Image_8___Packaging.webp' },
  { cat: 'facility', label: 'Warehouse', img: '/images/Gallery_Image_9___Warehouse.webp' },
];
